...
Shiptype.create(:radar_back => 1, :radar_w => 3, :radar_l => 10,:cannon_back => -5, :cannon_w => 11, :cannon_l => 15,:size => 5, :speed => 10,:turn_speed => 1,  :turn_index => 0,:armor => 2, :name => "Cruiser")
Shiptype.create(:radar_back => 1, :radar_w => 3, :radar_l => 8,:cannon_back => -4, :cannon_w => 9, :cannon_l => 12,:size => 4, :speed => 8,:turn_speed => 1,  :turn_index => 0, :armor => 1, :name => "Destroyer")
